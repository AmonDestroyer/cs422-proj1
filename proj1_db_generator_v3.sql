...
CREATE TABLE IF NOT EXISTS `proj1_db`.`Set Type` (
  `set_type_id` INT NOT NULL AUTO_INCREMENT,
  `set_type` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `proj1_db`.`Time Series` (
  ...
  `ts_name` VARCHAR(1000) NULL,
  `description` VARCHAR(1000) NULL,
  `y_unit` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `proj1_db`.`Contributor` (
  ...
  `contrib_fname` VARCHAR(1000) NULL,
  `contrib_lname` VARCHAR(1000) NULL,
...
CREATE TABLE IF NOT EXISTS `proj1_db`.`TS_Measurement` (
  `tsm_id` INT NOT NULL AUTO_INCREMENT,
  `x_val` INT NULL,
  `y_val` DOUBLE NULL,
  `ts_id` INT NOT NULL,
  PRIMARY KEY (`tsm_id`),
...
-- -----------------------------------------------------
-- Table `proj1_db`.`Test-Training-Solution_Join`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proj1_db`.`Test-Training-Solution_Join` (
  `training_set_id` INT NOT NULL,
  `other_set_id` INT NOT NULL,
  PRIMARY KEY (`training_set_id`, `other_set_id`),
  INDEX `fk_TS_Set_has_TS_Set_TS_Set1_idx` (`training_set_id` ASC) VISIBLE,
  INDEX `fk_TS_Set_has_TS_Set_TS_Set3_idx` (`other_set_id` ASC) VISIBLE,
  CONSTRAINT `fk_TS_Set_has_TS_Set_TS_Set1`
    FOREIGN KEY (`training_set_id`)
    REFERENCES `proj1_db`.`TS_Set` (`set_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TS_Set_has_TS_Set_TS_Set3`
    FOREIGN KEY (`other_set_id`)
    REFERENCES `proj1_db`.`TS_Set` (`set_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
